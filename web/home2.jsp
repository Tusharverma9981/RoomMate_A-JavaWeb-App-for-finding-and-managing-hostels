<%-- 
    Document   : home2
    Created on : 14 Mar, 2025, 7:22:53 PM
    Author     : tv464
--%>
...
<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary py-3 sticky-top">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="rules.html">Guidlines</a>
              </li>
               <li class="nav-item">
                <a class="nav-link" href="newListing.jsp">Create New Listing</a>
              </li>
               <li class="nav-item">
      ...
      <h2 class="text-center" id="simple-list-item-1">Your listings</h2>
